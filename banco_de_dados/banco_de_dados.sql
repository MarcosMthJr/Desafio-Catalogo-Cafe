...
('root', 'ALL_PLUGINS', 'view', 'information_schema', '');
...
('root', '[{\"db\":\"cafe_catalogo\",\"table\":\"catalogo\"},{\"db\":\"phpmyadmin\",\"table\":\"pma__users\"},{\"db\":\"mysql\",\"table\":\"user\"},{\"db\":\"mysql\",\"table\":\"time_zone\"},{\"db\":\"mysql\",\"table\":\"column_stats\"},{\"db\":\"mysql\",\"table\":\"db\"},{\"db\":\"mysql\",\"table\":\"host\"},{\"db\":\"information_schema\",\"table\":\"INNODB_METRICS\"},{\"db\":\"information_schema\",\"table\":\"INNODB_TRX\"}]');
...
('root', '2018-10-29 17:40:40', '{\"lang\":\"pt\",\"Console\\/Mode\":\"collapse\"}');
